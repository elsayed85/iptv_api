...
<body class="align">
    @livewire('login-with-previous')
    <form action="{{ route('login.auth') }}" method="POST" class="form login">
        @csrf
        <div class="form__field">
            <label for="login__url"><svg class="icon">
                    <use xlink:href="#icon-user"></use>
                </svg><span class="hidden">URL</span></label>
            <input autocomplete="url" id="login__url" type="text" name="url" class="form__input"
        ...
        <div class="form__field">
            <label for="login__portal"><svg class="icon">
                    <use xlink:href="#icon-user"></use>
            ...
            <input autocomplete="portal" id="login__portal" type="text" name="portal" class="form__input"
                placeholder="Portal" value="{{ old('portal') }}">
            @error('portal')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
