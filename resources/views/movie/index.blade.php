    ...
    <ul id="primary-menu" class="menu">
        @foreach ($categories as $category)
            <li id="menu-item-33" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-33"><a
                    href="{{ route('category.show', ['type' => 'movies', 'category' => $category['category_id']]) }}">
                ...
                <article id="post-75"
                    ...
                    <div class="post-featured-trending">
                        <div class="king-postext king-ext-75">
                            <a href="{{ route('movie.load', $movie['stream_id']) }}" class="king-share-link king-readlater"
                    ...
                    <header class="entry-header">
                        <h2 class="entry-title">
                            <a href="{{ route('movie.show', $movie['stream_id']) }}" rel="bookmark">
                                {{ $movie['name'] }}
                            </a>
                        </h2>
                    </header><!-- .entry-header -->
                    <div class="article-meta-04">
                        <div class="entry-meta-left">
                            <span class="content-04-avatar">
                                <a class="content-04-user" href="{{ route('movie.show', $movie['stream_id']) }}">
                                    {{ $movie['name'] }}
                                </a>
                            </span>
                        </div>
                        <div class="entry-meta-right">
                            <div class="entry-meta">
                                ...
                                <span class="post-views"><i class="fa fa-clock" aria-hidden="true"></i>
                                    {{ Carbon\Carbon::createFromTimestamp($movie['added'])->diffForHumans() }}
                                </span>
                            </div><!-- .entry-meta -->
